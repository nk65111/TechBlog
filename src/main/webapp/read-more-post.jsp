...
<%
  ...
  User us=udao.getUserByid(p.getUserid());
...
<body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="profile.jsp"><i class="fas fa-home"></i>Home</a>
            </li>
     ...
     <div class="row my-4">
        <div class="col-md-8 offset-md-2">
           <div class="card">
             ...
             <div class="card-body">
                <img src="postpic/<%=p.getPpic() %>"  class="card-img-top my-2" alt="...">
                
                <div class="row user-detail-info ">
                 <div class="col-md-8">
                 <p class="post-name"><a href='#!'><%=us.getName() %> </a>has posted:</p>
                 </div>
                 <div class="col-md-4">
             ...
             <div class="card-footer primary-background">
               ...
               %>
			    <a href="#!" onClick="likePost(<%= p.getPid() %>,<%= user.getId() %>)" class="btn btn-outline-light btn-sm"><i class="fas fa-thumbs-up"></i><span id="like-btn"> <%= ldao.countLikePost(p.getPid()) %></span></a>
			    <a href="#!" class="btn btn-outline-light btn-sm"><i class="fas fa-comment"></i><span>20</span></a>
			  </div>
			  <div class="card-footer">
                 <div class="fb-comments" data-href="http://localhost:8080/TechBlog/read-more-post.jsp?post_id=<%=p.getPid() %>" data-width="" data-numposts="5"></div>
            </div>
 ...
 <!-- modal open -->
  ...
  <!--javascript cdn-->
	...
	<div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v12.0" nonce="T5eIlDnZ"></script>
</body>
